               <div class="col-md-3 col-sm-6 hero-feature">
					...
					<img src="<?= $jogo['imagem']?>" alt="<?=jogo['detalhes']?>">
					<div class="caption">
		                                <h4 class="pull-right">R$ <?= $jogo['valor']?></h4>
                                <h4><a href="#"><?= $jogo['nome'] ?></a>
                                </h4>
                                <p><?= $jogo['detalhes']?> - See more snippets like this online store item at <a target="_blank" href="https://www.ea.com/pt-br">Bootsnipp - http://bootsnipp.com</a>.</p>
                            </div>
                            <div class="ratings">
